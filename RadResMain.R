...
##User adjustable parameters are those near line 147 and also limits on x and y axes for some of the graphs
...
r=c(.7,.006*c(9,8,7,6,5,5,4,3,2,1)); L=c(.4,25*(1:10)); proton =c(1,rep(0,10)); Eff=2; N = 100 #use N >= 50 to get 95% CI
#r=c(.5,.5); L=c(50,200); proton = c(0,0); Eff=1; N = 100 #alternative line, Use even bigger N  (e.g. N=10000)for more accurate CI
#r=c(.4,.4,.2); L=c(50,50,200); proton = c(0,0,0); Eff=2; N = 100 #This and following line should give the same result: an example of 
#r=c(.8,.2); L=c(50,200); proton = c(0,0); Eff=2; N = 50          #making sure that E_I obeys the sham mixture principle
